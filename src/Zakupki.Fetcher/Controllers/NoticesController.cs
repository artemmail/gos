...
public class NoticesController : ControllerBase
{
    ...
    {
        var computedRegion = RegionDetection.DetermineRegionCode(notice.RawJson, notice.Region);
        var dbRegion = notice.Region.ToString("D2");
        var computedRegionText = computedRegion.ToString("D2");
        var baseName = notice.KvrName;

        var debugInfo = $"[db:{dbRegion}; func:{computedRegionText}]";
